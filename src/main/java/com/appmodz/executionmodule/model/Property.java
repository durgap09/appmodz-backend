...
public class Property {
    ...
    @Column(name="Property_Is_Advanced")
    private Boolean isAdvanced;

    @OneToMany(targetEntity= PropertyL2.class, fetch = FetchType.EAGER,cascade=CascadeType.ALL)
    @JoinColumn(name="SubProperty_Fk")
    private List<PropertyL2> subProperties;

...
@lombok.Setter
@lombok.ToString
@Table(name="Properties_L3")
public class PropertyL3 {
    @Id
    ...
    @OneToMany(targetEntity=PropertyL4.class, fetch = FetchType.EAGER,cascade=CascadeType.ALL)
    @JoinColumn(name="PropertyL3_FK")
    private List<PropertyL4> subProperties;

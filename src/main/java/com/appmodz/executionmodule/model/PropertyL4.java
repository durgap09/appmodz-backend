...
@lombok.Setter
@lombok.ToString
@Table(name="Properties_L4")
public class PropertyL4 {
    @Id
    ...
    @OneToMany(targetEntity=PropertyL5.class, fetch = FetchType.EAGER,cascade=CascadeType.ALL)
    @JoinColumn(name="PropertyL4_FK")
    private List<PropertyL5> subProperties;
